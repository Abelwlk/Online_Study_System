...
public class AdminController {
    ...
    @Resource(name = "courseVideoServiceImpl")
    ...
    public String editCourse(Course course, @RequestParam("video")MultipartFile video) throws Exception {
        if(video.isEmpty()){
            course.setVideoId(null);
        }else {
            int i = courseVideoService.saveVideo(course, video);
            course.setVideoId(i);
        }
    ...
    public String addCourse(Course course,@RequestParam("video") MultipartFile video) throws Exception {

        if(video.isEmpty()){
            course.setVideoId(1);
        }else {
            course.setVideoId(courseVideoService.saveVideo(course,video));
        }
