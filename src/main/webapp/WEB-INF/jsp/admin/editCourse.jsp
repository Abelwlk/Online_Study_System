			...
			<div class="col-md-10">
				<div class="panel panel-default">
				    ...
				    <div class="panel-body">
						<form class="form-horizontal" role="form" action="${ctx}/admin/editCourse" id="editfrom" method="post" enctype="multipart/form-data">
							...
							<div class="form-group">
								<label for="videoId" class="col-sm-2 control-label">课程视频</label>
								<div class="col-md-4 col-sm-4  col-xs-4 col-lg-4">
									<input type="text" class="form-control" readonly="readonly" id="videoId"  value="${course.courseVideo.name}" placeholder="课程视频">
								</div>
								<div class="col-md-4 col-sm-4  col-xs-4 col-lg-4">
